...
exports.mockHostawayReviews = void 0;
exports.mockHostawayReviews = {
    status: 'success',
    result: [
        {
            id: 7453,
        ...
        },
        {
            ...
            status: 'published',
            rating: 4.0,
            publicReview: 'A cozy place, good location, but had a minor issue with the Wi-Fi. Overall, a pleasant stay.',
            reviewCategory: [
        ...
        },
        {
            ...
            status: 'published',
            rating: 5.0,
            publicReview: 'Absolutely fantastic! The place was spotless, communication was great, and the location was perfect for exploring London.',
            reviewCategory: [
                { category: 'cleanliness', rating: 5 },
                { category: 'communication', rating: 5 },
        ...
        },
        {
            ...
            status: 'published',
            rating: 3.5,
            publicReview: 'The apartment was okay, but a bit noisy at night. Host was responsive.',
            reviewCategory: [
        ...
        },
        {
            ...
            status: 'published',
            rating: 4.5,
            publicReview: 'Lovely stay, very comfortable and well-equipped. Would recommend.',
            reviewCategory: [
                { category: 'cleanliness', rating: 4.5 },
        ...
        },
        {
            ...
            status: 'published',
            rating: 3.25,
            publicReview: "The location was great, but the apartment felt a bit dated. Some appliances weren't working.",
            reviewCategory: [
                { category: 'location', rating: 4.5 },
        ...
        },
        {
            ...
            status: 'published',
            rating: 4.25,
            publicReview: 'Good value for money. The host was helpful, and the apartment was clean.',
            reviewCategory: [
        ...
        },
        {
            ...
            status: 'published',
            rating: 4.5,
            publicReview: 'Beautifully decorated flat with excellent amenities. Enjoyed my stay.',
            reviewCategory: [
